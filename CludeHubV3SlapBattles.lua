...
local slapAuraLoop
local slapAuraStatus = "SLAP AURA: OFF" -- This is the text you can add to your GUI
...
local function toggleSlapAura()
    ...
    slapAuraStatus = slapAuraEnabled and "SLAP AURA: ON" or "SLAP AURA: OFF" -- Update the text
...
-- Example Usage: Call toggleSlapAura() to switch it ON/OFF
toggleSlapAura()
